  ...
  def table_data
    @table_setup ||= begin
      [{
        title: nil,
        cells: [
          cell("3-Methyl-2-Butene-Thiol", "Also known as Mercaptan. A compound causing a sulfuric, skunky aroma, typically due to a reaction between hops’ alpha acids and sulfur compounds in the presence of sunlight or electric light. Clear, green and blue bottles are most at risk for developing 3-methyl-2-butene-thiol."),
